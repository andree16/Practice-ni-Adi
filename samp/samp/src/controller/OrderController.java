...
public class OrderController implements Initializable{
    ...
    @FXML
    Label name1, name2, name3, price1, price2, price3, qty1, qty2, qty3, date1, date2, date3, totalLabel;
    ...
    public  void initialize(URL arg0, ResourceBundle arg1){
        ...
        totalLabel.setText(CheckoutController.totalT);
